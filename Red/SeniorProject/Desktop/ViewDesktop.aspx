<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewDesktop.aspx.cs" Inherits="SeniorProject.ViewDesktop" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="style1">
        <tr>
            ...
            <td class="style6" style="margin-left: 40px">
                <asp:TextBox ID="txtBoxServiceTag" runat="server"></asp:TextBox>
            </td>
            <td class="style6">
                    SMSU Tag:</td>
            <td>
    ...
    <table class="style1">
        <tr>
            ...
            <td class="style6">
                    Video Card:</td>
            <td>
                <asp:TextBox ID="txtBoxVideoCard" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style6">
        ...
        <tr>
            <td class="style6">
                    Size:</td>
            <td class="style6" style="margin-left: 200px">
            ...
            <td style="margin-left: 40px">
                <asp:DropDownList ID="ddlMonitor" runat="server" AutoPostBack="True" 
                    DataSourceID="SqlDataSource3" DataTextField="Display" DataValueField="id">
                </asp:DropDownList>
                <asp:SqlDataSource ID="SqlDataSource3" runat="server" 
                    ConnectionString="<%$ ConnectionStrings:EquipmentConnectionString %>" 
                    SelectCommand="SELECT [id], [Display] FROM [Monitor]"></asp:SqlDataSource>
            </td>
        </tr>
        <tr>
            <td class="style6">
    ...
    <p>
        <asp:Button ID="btnUpdateDesktop" runat="server" Text="Update" Width="100px" 
            onclick="btnUpdateDesktop_Click"/>
    </p>
    <p>
